...
import React,{useState, setName,useRef, startTransition } from 'react';
...
<div>
  <input className='Bar slider ' type="range" name="volume"
step="0.000000001"       onChange={(event)=>handleChange(event)}
 value={props.mCurrentTime}  max={duration}></input>
</div>


<div className='text-end col-12  playerStats'>
{convertMS(props.mCurrentTime)} / {convertMS(duration)}    </div>
