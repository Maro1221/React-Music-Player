...
export function Player(props){
    ...
    if ('mediaSession' in navigator) {
        ...
        navigator.mediaSession.setActionHandler('play', function() {     if(typeof music=="object"){
        ...
        navigator.mediaSession.setActionHandler('pause', function() {if(typeof music=="object"){
...
props.pMusic.pause()
    ...
    const music = useLiveQuery(
      ...
      const id = useLiveQuery(
        () => db.curretplay.toArray()
      );   
...
>
    ...
    <p className='statsSmall  sP  playerStats'>
        {props.artist}
</p>    
    ...
    {props.album}</p>
        ...
        <div className='col-7 playerBox col-xl-9 mx-auto'>
            ...
            <Bar setcMusic={props.setcMusic} cMusic={props.cMusic} pMusic={props.pMusic} mCurrentTime={props.mCurrentTime} pause={props.pause} setmCurrentTime={props.setmCurrentTime} Mduration={props.Mduration}/>
    

    <div className='buttons text-center '>
    <div onClick={() =>previous()} className="musicPlayerIcon pointer material-symbols-outlined">
skip_previous
</div>
 {(props.pause==true)
       ?    
    <div onClick={() =>resume(props.pMusic)}className="musicPlayerIcon  pointer material-symbols-outlined">
    play_arrow
    </div>:
        
     
    <div onClick={() =>pause(props.pMusic)}className="musicPlayerIcon   pointer material-symbols-outlined">
    pause
    </div>}
    <div onClick={() =>next()} className="pointer musicPlayerIcon material-symbols-outlined">
skip_next
</div><div onClick={() =>loop()}className="  material-symbols-outlined musicRepeatIcon pointer">
{loppIcon[props.repeat]}
</div>
    </div><div className=' Me  h6 text-end'>Made with ❤️ by Marek Wypych</div>
